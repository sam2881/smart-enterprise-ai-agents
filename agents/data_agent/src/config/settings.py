...
class Settings(BaseSettings):
    ...
    environment: Literal["local", "dev", "qa", "prod"] = Field(
        default="dev",
...
class DevSettings(Settings):
    ...
    environment: Literal["local", "dev", "qa", "prod"] = "dev"
    debug: bool = True
...
class QASettings(Settings):
    ...
    environment: Literal["local", "dev", "qa", "prod"] = "qa"
    debug: bool = False
...
class ProdSettings(Settings):
    ...
    environment: Literal["local", "dev", "qa", "prod"] = "prod"
    debug: bool = False
    log_level: Literal["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"] = "INFO"
