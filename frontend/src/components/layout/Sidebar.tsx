...
const navSections: NavSection[] = [
  ...
  {
    id: 'jira',
    title: 'Jira & Pipelines',
    icon: Ticket,
    gradient: 'from-blue-500 to-cyan-500',
    items: [
      { name: 'All Tickets', href: '/jira', icon: Ticket },
      { name: 'Pipeline Status', href: '/pipelines', icon: Database },
...
export function Sidebar() {
  ...
  useEffect(() => {
    ...
    // Both /pipelines and /jira routes expand the jira section
    if (pathname?.startsWith('/pipelines') || pathname?.startsWith('/jira')) {
