...
async def node_classify(state: WorkflowState) -> WorkflowState:
    ...
    try:
        ...
        # Store extracted parameters for later use during execution
        state["extracted_params"] = classification_result.get("required_params", {})
...
async def node_generate_plan(state: WorkflowState) -> WorkflowState:
    ...
    try:
        ...
        state["plan"] = {
            ...
            "extracted_params": plan_result.get("extracted_params", {})
        }

        # Merge extracted params from classify and plan generation
        if plan_result.get("extracted_params"):
            state["extracted_params"] = {
                **state.get("extracted_params", {}),
                **plan_result.get("extracted_params", {})
            }
...
async def node_feedback_loop(state: WorkflowState) -> WorkflowState:
    ...
    try:
        ...
        try:
            from backend.rag.rag_updater import get_rag_updater
