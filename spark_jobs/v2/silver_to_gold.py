...
def run_data_vault(args):
    ...
    print(f"[silver_to_gold] Step 1: Run load_hub.py with:")
    ...
    print(f"[silver_to_gold] Step 2: Run load_satellite.py with:")
    print(f"    --feed-id {args.feed_id}")
    print(f"    --execution-id {args.execution_id}")
    print(f"    --metadata-db {args.metadata_db}")
    print(f"    --source-path {args.silver_path}")
...
def run_star_schema(args):
    ...
    print(f"[silver_to_gold] Step 1: Run load_dimension.py with:")
    print(f"    --feed-id {args.feed_id}")
    print(f"    --execution-id {args.execution_id}")
    print(f"    --metadata-db {args.metadata_db}")
    print(f"    --source-path {args.silver_path}")
    ...
    print(f"[silver_to_gold] Step 2: Run load_dimension.py for each dimension table")
